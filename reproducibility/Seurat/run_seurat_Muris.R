...
# write.table(df_anchor, file=paste0(read_dir, glue("seuratAnchors_hvg5000.csv")), quote=F, sep=',', row.names = T, col.names = NA)
...
write.table(seurat_pca, 
            file=paste0(working_dir, glue("{outfile_prefix}_hvg5000_seurat_pca.csv")), quote=F, sep='\t', row.names = T, col.names = NA)
